...
export const defaultSettlementData: SettlementType[] = [
  { type: "Isolated", description: "Comprised of outlaws, traveling merchants, adventurers, isolated families, etc.", distributionType: "gaussian", minPopulation: 1, maxPopulation: 20},
  { type: "Village", description: "A small self sufficient community of people.", distributionType: "gaussian", minPopulation: 20, maxPopulation: 1000},
  { type: "Town", description: "A mid sized community of people.", distributionType: "gaussian", minPopulation: 1000, maxPopulation: 5000},
  { type: "City", description: "A large community of people.", distributionType: "gaussian", minPopulation: 5000, maxPopulation: 15000},
  { type: "Big City", description: "A very large community of people.", distributionType: "gaussian", minPopulation: 15000, maxPopulation: 25000},
  { type: "Metropolis", description: "A massive community of people.", distributionType: "gaussian", minPopulation: 25000, maxPopulation: 250000}
];
